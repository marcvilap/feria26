...
| Spot | Sección | Posición | Formato |
| ---: | --- | --- | --- |
| 01 | Home | Pop-up | Imagen + vídeo |
| 02 | Revista de Feria | Lateral | Solo imagen |
...
| 23 | Saludos | Lateral | Imagen + vídeo |
...
| 34 | Curiosidades › Vídeos | Lateral | Imagen + vídeo |
| 35 | Curiosidades › Vídeos | Móvil | Imagen + vídeo |
| 36 | Curiosidades › Vídeos | Móvil | Imagen + vídeo |
| 37 | Curiosidades › Vídeos | Pop-up (uno por vídeo) | Imagen + vídeo |
| 38 | Curiosidades › Vídeos | Pop-up (uno por vídeo) | Imagen + vídeo |
| 39 | Curiosidades › Vídeos | Pop-up (uno por vídeo) | Imagen + vídeo |
| 40 | Curiosidades › Vídeos | Pop-up (uno por vídeo) | Imagen + vídeo |
| 41 | Curiosidades › Vídeos | Pop-up (uno por vídeo) | Imagen + vídeo |
| 42 | Curiosidades › Vídeos | Pop-up (uno por vídeo) | Imagen + vídeo |
| 43 | Te lo cuenta COPE Málaga | Lateral | Solo imagen |
| 44 | Te lo cuenta COPE Málaga | Lateral | Imagen + vídeo |
| 45 | Te lo cuenta COPE Málaga | Móvil | Solo imagen |
| 46 | Te lo cuenta COPE Málaga | Móvil | Imagen + vídeo |
| 47 | Te lo cuenta COPE Málaga | Pop-up (uno por vídeo) | Imagen + vídeo |
| 48 | Te lo cuenta COPE Málaga | Pop-up (uno por vídeo) | Imagen + vídeo |
| 49 | Te lo cuenta COPE Málaga | Pop-up (uno por vídeo) | Imagen + vídeo |
| 50 | Te lo cuenta COPE Málaga | Pop-up (uno por vídeo) | Imagen + vídeo |
| 51 | Te lo cuenta COPE Málaga | Pop-up (uno por vídeo) | Imagen + vídeo |
| 52 | Test de la Feria | Lateral | Imagen + vídeo |
| 53 | Test de la Feria | Móvil | Imagen + vídeo |
| 54 | Test de la Feria | Móvil | Solo imagen |
| 55 | Test de la Feria | Pop-up (uno por vídeo) | Solo imagen |
| 56 | Test de la Feria | Pop-up (uno por vídeo) | Solo imagen |
| 57 | Test de la Feria | Pop-up (uno por vídeo) | Solo imagen |
| 58 | Test de la Feria | Pop-up (uno por vídeo) | Solo imagen |
| 59 | Biznaga de Plata | Lateral | Solo imagen |
| 60 | Biznaga de Plata | Móvil | Imagen + vídeo |
| 61 | Biznaga de Plata | Móvil | Solo imagen |
| 62 | Biznaga de Plata › Votaciones | Lateral | Imagen + vídeo |
| 63 | Biznaga de Plata › Votaciones | Móvil | Imagen + vídeo |
| 64 | Biznaga de Plata › Votaciones | Móvil | Imagen + vídeo |
| 65 | Carteles de Feria | Lateral | Imagen + vídeo |
| 66 | Carteles de Feria | Lateral | Imagen + vídeo |
| 67 | Carteles de Feria | Lateral | Solo imagen |
...
| 76 | El vino y la Feria | Pop-up (uno por vídeo) | Imagen + vídeo |
...
comportamiento, basta con indicar qué spots comparten creatividad.

Los huecos marcados **«uno por vídeo»** son individuales: cada pieza abre su
propio pop-up con su propio número, así que se pueden vender por separado. Hoy
todos ellos comparten la creatividad declarada en `modalAd` dentro de la página;
para darle una distinta a cada uno hay que ampliar ese objeto cuando lleguen los
materiales.

El formato de cada hueco no es inamovible: convertir un "solo imagen" en
"imagen + vídeo" es añadir el MP4 al objeto correspondiente en la página.

## Cómo publicar la publicidad real

1. Sustituir los ficheros de `src/assets/images/ads/` y `src/assets/videos/ads/`
   por las creatividades de 2026.
2. Actualizar la `url` de destino de cada hueco en su página.
3. Poner `showAds = true` en `src/utils/config.ts`.
